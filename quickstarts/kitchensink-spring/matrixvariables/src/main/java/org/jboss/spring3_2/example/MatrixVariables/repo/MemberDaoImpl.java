...
public class MemberDaoImpl implements MemberDao {
    ...
    public List<Member> findByNameAndEmail(String name, String email) {
        ...
        if (name != null && !name.isEmpty() && name != "")
            criteria.where(builder.like(member.get(type.getDeclaredSingularAttribute("name", String.class)), "%" + name + "%"));
        if (email != null && !email.isEmpty() && email != "")
            criteria.where(builder.like(member.get(type.getDeclaredSingularAttribute("email", String.class)), "%" + email + "%"));
